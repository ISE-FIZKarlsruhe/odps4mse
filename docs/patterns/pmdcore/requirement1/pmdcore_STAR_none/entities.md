...
- **Prozess** (*Class*) — `Process` — <https://w3id.org/pmd/co/Process>
  <span class='search-tokens' style='display:none'>Process Prozess https://w3id.org/pmd/co/ Process https://w3id.org/pmd/co/ process https://w3id.org/pmd/co/Process https://w3id.org/pmd/co/process process prozess</span>
