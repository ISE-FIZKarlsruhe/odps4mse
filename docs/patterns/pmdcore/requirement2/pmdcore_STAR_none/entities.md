...
- **Sollwert** (*Class*) — `SetPoint` — <https://w3id.org/pmd/co/SetPoint>
  <span class='search-tokens' style='display:none'>Set Point SetPoint Sollwert https://w3id.org/pmd/co/ Set Point https://w3id.org/pmd/co/ set point https://w3id.org/pmd/co/SetPoint https://w3id.org/pmd/co/setpoint set point setpoint sollwert</span>
- **Material Related** (*Class*) — `MaterialRelated` — <https://w3id.org/pmd/co/MaterialRelated>
  <span class='search-tokens' style='display:none'>Material  Related Material Related MaterialRelated https://w3id.org/pmd/co/ Material Related https://w3id.org/pmd/co/ material related https://w3id.org/pmd/co/MaterialRelated https://w3id.org/pmd/co/materialrelated material  related material related materialrelated</span>
