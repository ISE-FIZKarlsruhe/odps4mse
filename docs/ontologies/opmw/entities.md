...
- **"** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>"</span>
- **has File Name** (*DatatypeProperty*) — `hasFileName` — <http://www.opmw.org/ontology/hasFileName> — _comment:_ "Property used to link an execution artifact to its file name (independently of its URI).
...
- **has Location** (*DatatypeProperty*) — `hasLocation` — <http://www.opmw.org/ontology/hasLocation> — _comment:_ "Property used to link an execution artifact to the physical location of its file in the server.
  <span class='search-tokens' style='display:none'>has  Location has  location has Location has location hasLocation haslocation http://www.opmw.org/ontology/has Location http://www.opmw.org/ontology/has location http://www.opmw.org/ontology/hasLocation http://www.opmw.org/ontology/haslocation</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **Example** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>Example example</span>
...
- **InstantaneousEvent** (*Class*) — `InstantaneousEvent` — <http://www.w3.org/ns/prov#InstantaneousEvent> — _comment:_ An instantaneous event, or event for short, happens in the world and marks a change in the world, in its activities and in its entities. The term 'event' is commonly used in process algebra with a similar meaning. Events represent communications or interactions; they are assumed to be atomic and instantaneous.
...
- **qualifiedEnd** (*ObjectProperty*) — `qualifiedEnd` — <http://www.w3.org/ns/prov#qualifiedEnd> — _comment:_ If this Activity prov:wasEndedBy Entity :e1, then it can qualify how it was ended using prov:qualifiedEnd [ a prov:End;  prov:entity :e1; :foo :bar ].
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#qualified End http://www.w3.org/ns/prov#qualified end http://www.w3.org/ns/prov#qualifiedEnd http://www.w3.org/ns/prov#qualifiedend qualified End qualified end qualifiedEnd qualifiedend</span>
...
- **overall Start Time** (*DatatypeProperty*) — `overallStartTime` — <http://www.opmw.org/ontology/overallStartTime> — _comment:_ "Property which states that none of the activities in the current account started executing before the start time.
  <span class='search-tokens' style='display:none'>http://www.opmw.org/ontology/overall Start Time http://www.opmw.org/ontology/overall start time http://www.opmw.org/ontology/overallStartTime http://www.opmw.org/ontology/overallstarttime overall  Start  Time overall  start  time overall Start Time overall start time overallStartTime overallstarttime</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **Example:** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>Example: example:</span>
...
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **<http://www.opmw.org/export/resource/DataVariable/AQUAFLOW_NTM_DAILYDATA>** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'><http://www.opmw.org/export/resource/ Data Variable/AQUAFLOW NTM DAILYDATA> <http://www.opmw.org/export/resource/ data variable/aquaflow ntm dailydata> <http://www.opmw.org/export/resource/DataVariable/AQUAFLOW NTM DAILYDATA> <http://www.opmw.org/export/resource/DataVariable/AQUAFLOW_NTM_DAILYDATA> <http://www.opmw.org/export/resource/datavariable/aquaflow_ntm_dailydata></span>
- **     a opmw:DataVariable, opmw:WorkflowTemplateArtifact;** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>     a opmw: Data Variable, opmw: Workflow Template Artifact;      a opmw: data variable, opmw: workflow template artifact;      a opmw:DataVariable, opmw:WorkflowTemplateArtifact;      a opmw:datavariable, opmw:workflowtemplateartifact;</span>
- **     opmw:hasDimensionality ""1""^^xsd:int.** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>     opmw:has Dimensionality ""1""^^xsd:int.      opmw:has dimensionality ""1""^^xsd:int.      opmw:hasDimensionality ""1""^^xsd:int.      opmw:hasdimensionality ""1""^^xsd:int.</span>
- **"** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>"</span>
...
- **     opmw:hasEndTime** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>     opmw:has End Time      opmw:has end time      opmw:hasEndTime      opmw:hasendtime</span>
...
- **endedAtTime** (*DatatypeProperty*) — `endedAtTime` — <http://www.w3.org/ns/prov#endedAtTime> — _comment:_ The time at which an activity ended. See also prov:startedAtTime.
...
- **hadPlan** (*ObjectProperty*) — `hadPlan` — <http://www.w3.org/ns/prov#hadPlan> — _comment:_ The _optional_ Plan adopted by an Agent in Association with some Activity. Plan specifications are out of the scope of this specification.
  <span class='search-tokens' style='display:none'>had Plan had plan hadPlan hadplan http://www.w3.org/ns/prov#had Plan http://www.w3.org/ns/prov#had plan http://www.w3.org/ns/prov#hadPlan http://www.w3.org/ns/prov#hadplan</span>
- **Quotation** (*Class*) — `Quotation` — <http://www.w3.org/ns/prov#Quotation> — _comment:_ An instance of prov:Quotation provides additional descriptions about the binary prov:wasQuotedFrom relation from some taken prov:Entity from an earlier, larger prov:Entity. For example, :here_is_looking_at_you_kid prov:wasQuotedFrom :casablanca_script; prov:qualifiedQuotation [ a prov:Quotation; prov:entity :casablanca_script; :foo :bar ].
  <span class='search-tokens' style='display:none'>Quotation http://www.w3.org/ns/prov# Quotation http://www.w3.org/ns/prov# quotation http://www.w3.org/ns/prov#Quotation http://www.w3.org/ns/prov#quotation quotation</span>
- **hadUsage** (*ObjectProperty*) — `hadUsage` — <http://www.w3.org/ns/prov#hadUsage> — _comment:_ The _optional_ Usage involved in an Entity's Derivation.
  <span class='search-tokens' style='display:none'>had Usage had usage hadUsage hadusage http://www.w3.org/ns/prov#had Usage http://www.w3.org/ns/prov#had usage http://www.w3.org/ns/prov#hadUsage http://www.w3.org/ns/prov#hadusage</span>
- **hadActivity** (*ObjectProperty*) — `hadActivity` — <http://www.w3.org/ns/prov#hadActivity> — _comment:_ The _optional_ Activity of an Influence, which used, generated, invalidated, or was the responsibility of some Entity. This property is _not_ used by ActivityInfluence (use prov:activity instead).
  <span class='search-tokens' style='display:none'>had Activity had activity hadActivity hadactivity http://www.w3.org/ns/prov#had Activity http://www.w3.org/ns/prov#had activity http://www.w3.org/ns/prov#hadActivity http://www.w3.org/ns/prov#hadactivity</span>
- **wasAttributedTo** (*ObjectProperty*) — `wasAttributedTo` — <http://www.w3.org/ns/prov#wasAttributedTo> — _comment:_ Attribution is the ascribing of an entity to an agent.
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#was Attributed To http://www.w3.org/ns/prov#was attributed to http://www.w3.org/ns/prov#wasAttributedTo http://www.w3.org/ns/prov#wasattributedto was Attributed To was attributed to wasAttributedTo wasattributedto</span>
- **has Execution Diagram** (*DatatypeProperty*) — `hasExecutionDiagram` — <http://www.opmw.org/ontology/hasExecutionDiagram> — _comment:_ "Property that links an execution account to its diagram. The diagram shows how the template has been instantiated with different components.
  <span class='search-tokens' style='display:none'>has  Execution  Diagram has  execution  diagram has Execution Diagram has execution diagram hasExecutionDiagram hasexecutiondiagram http://www.opmw.org/ontology/has Execution Diagram http://www.opmw.org/ontology/has execution diagram http://www.opmw.org/ontology/hasExecutionDiagram http://www.opmw.org/ontology/hasexecutiondiagram</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **Example:** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>Example: example:</span>
...
- **     a opmw:WorkflowExecutionAccount,opmo:Account;** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>     a opmw: Workflow Execution Account,opmo: Account;      a opmw: workflow execution account,opmo: account;      a opmw:WorkflowExecutionAccount,opmo:Account;      a opmw:workflowexecutionaccount,opmo:account;</span>
- **     opmw:hasExecutionDiagram ""http://wind.isi.edu/marbles/assets/components/workflow_portal/users/1/Water/runs/run_148.png""^^sxd:anyURI."** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>     opmw:has Execution Diagram ""http://wind.isi.edu/marbles/assets/components/workflow portal/users/1/ Water/runs/run 148.png""^^sxd:anyURI."      opmw:has execution diagram ""http://wind.isi.edu/marbles/assets/components/workflow portal/users/1/ water/runs/run 148.png""^^sxd:anyuri."      opmw:hasExecutionDiagram ""http://wind.isi.edu/marbles/assets/components/workflow portal/users/1/Water/runs/run 148.png""^^sxd:anyURI."      opmw:hasExecutionDiagram ""http://wind.isi.edu/marbles/assets/components/workflow_portal/users/1/Water/runs/run_148.png""^^sxd:anyURI."      opmw:hasexecutiondiagram ""http://wind.isi.edu/marbles/assets/components/workflow_portal/users/1/water/runs/run_148.png""^^sxd:anyuri."</span>
- **is Concrete** (*DatatypeProperty*) — `isConcrete` — <http://www.opmw.org/ontology/isConcrete> — _comment:_ Property that specifies whether a component is abstract or not.
  <span class='search-tokens' style='display:none'>http://www.opmw.org/ontology/is Concrete http://www.opmw.org/ontology/is concrete http://www.opmw.org/ontology/isConcrete http://www.opmw.org/ontology/isconcrete is  Concrete is  concrete is Concrete is concrete isConcrete isconcrete</span>
- **specializationOf** (*AnnotationProperty*) — `specializationOf` — <http://www.w3.org/ns/prov#specializationOf>
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#specialization Of http://www.w3.org/ns/prov#specialization of http://www.w3.org/ns/prov#specializationOf http://www.w3.org/ns/prov#specializationof specialization Of specialization of specializationOf specializationof</span>
- **wasRevisionOf** (*AnnotationProperty*) — `wasRevisionOf` — <http://www.w3.org/ns/prov#wasRevisionOf> — _comment:_ A revision is a derivation that revises an entity into a revised version.
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#was Revision Of http://www.w3.org/ns/prov#was revision of http://www.w3.org/ns/prov#wasRevisionOf http://www.w3.org/ns/prov#wasrevisionof was Revision Of was revision of wasRevisionOf wasrevisionof</span>
...
- **qualifiedForm** (*AnnotationProperty*) — `qualifiedForm` — <http://www.w3.org/ns/prov#qualifiedForm> — _comment:_ "This annotation property links a subproperty of prov:wasInfluencedBy with the subclass of prov:Influence and the qualifying property that are used to qualify it. 
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#qualified Form http://www.w3.org/ns/prov#qualified form http://www.w3.org/ns/prov#qualifiedForm http://www.w3.org/ns/prov#qualifiedform qualified Form qualified form qualifiedForm qualifiedform</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **Example annotation:** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>Example annotation: example annotation:</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **    prov:wasGeneratedBy prov:qualifiedForm prov:qualifiedGeneration, prov:Generation .** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>    prov:was Generated By prov:qualified Form prov:qualified Generation, prov: Generation .     prov:was generated by prov:qualified form prov:qualified generation, prov: generation .     prov:wasGeneratedBy prov:qualifiedForm prov:qualifiedGeneration, prov:Generation .     prov:wasgeneratedby prov:qualifiedform prov:qualifiedgeneration, prov:generation .</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **Then this unqualified assertion:** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>Then this unqualified assertion: then this unqualified assertion:</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **    :entity1 prov:wasGeneratedBy :activity1 .** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>    :entity1 prov:was Generated By :activity1 .     :entity1 prov:was generated by :activity1 .     :entity1 prov:wasGeneratedBy :activity1 .     :entity1 prov:wasgeneratedby :activity1 .</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **can be qualified by adding:** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>can be qualified by adding:</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **   :entity1 prov:qualifiedGeneration :entity1Gen .** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>   :entity1 prov:qualified Generation :entity1 Gen .    :entity1 prov:qualified generation :entity1 gen .    :entity1 prov:qualifiedGeneration :entity1Gen .    :entity1 prov:qualifiedgeneration :entity1gen .</span>
- **   :entity1Gen ** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>   :entity1 Gen     :entity1 gen     :entity1Gen     :entity1gen </span>
- **       a prov:Generation, prov:Influence;** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>       a prov: Generation, prov: Influence;        a prov: generation, prov: influence;        a prov:Generation, prov:Influence;        a prov:generation, prov:influence;</span>
- **       prov:activity :activity1;** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>       prov:activity :activity1;</span>
- **       :customValue 1337 .** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>       :custom Value 1337 .        :custom value 1337 .        :customValue 1337 .        :customvalue 1337 .</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **Note how the value of the unqualified influence (prov:wasGeneratedBy :activity1) is mirrored as the value of the prov:activity (or prov:entity, or prov:agent) property on the influence class."** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>Note how the value of the unqualified influence (prov:was Generated By :activity1) is mirrored as the value of the prov:activity (or prov:entity, or prov:agent) property on the influence class." Note how the value of the unqualified influence (prov:wasGeneratedBy :activity1) is mirrored as the value of the prov:activity (or prov:entity, or prov:agent) property on the influence class." note how the value of the unqualified influence (prov:was generated by :activity1) is mirrored as the value of the prov:activity (or prov:entity, or prov:agent) property on the influence class." note how the value of the unqualified influence (prov:wasgeneratedby :activity1) is mirrored as the value of the prov:activity (or prov:entity, or prov:agent) property on the influence class."</span>
- **prov-o-20120312** (*Individual*) — `prov-o-20120312` — <http://www.w3.org/ns/prov-o-20120312>
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov o 20120312 http://www.w3.org/ns/prov-o-20120312 prov o 20120312 prov-o-20120312</span>
- **wasEndedBy** (*ObjectProperty*) — `wasEndedBy` — <http://www.w3.org/ns/prov#wasEndedBy> — _comment:_ End is when an activity is deemed to have ended. An end may refer to an entity, known as trigger, that terminated the activity.
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#was Ended By http://www.w3.org/ns/prov#was ended by http://www.w3.org/ns/prov#wasEndedBy http://www.w3.org/ns/prov#wasendedby was Ended By was ended by wasEndedBy wasendedby</span>
- **hadRole** (*ObjectProperty*) — `hadRole` — <http://www.w3.org/ns/prov#hadRole> — _comment:_ The _optional_ Role that an Entity assumed in the context of an Activity. For example, :baking prov:used :spoon; prov:qualified [ a prov:Usage; prov:entity :spoon; prov:hadRole roles:mixing_implement ].
  <span class='search-tokens' style='display:none'>had Role had role hadRole hadrole http://www.w3.org/ns/prov#had Role http://www.w3.org/ns/prov#had role http://www.w3.org/ns/prov#hadRole http://www.w3.org/ns/prov#hadrole</span>
- **category** (*AnnotationProperty*) — `category` — <http://www.w3.org/ns/prov#category> — _comment:_ Classify prov-o terms into three categories, including 'starting-point', 'qualifed', and 'extended'. This classification is used by the prov-o html document to gently introduce prov-o terms to its users. 
  <span class='search-tokens' style='display:none'>category http://www.w3.org/ns/prov#category</span>
...
- **OPMGraph** (*Class*) — `OPMGraph` — <http://openprovenance.org/model/opmo#OPMGraph>
  <span class='search-tokens' style='display:none'>OPM Graph OPMGraph http://openprovenance.org/model/opmo#OPM Graph http://openprovenance.org/model/opmo#OPMGraph http://openprovenance.org/model/opmo#opm graph http://openprovenance.org/model/opmo#opmgraph opm graph opmgraph</span>
- **atLocation** (*ObjectProperty*) — `atLocation` — <http://www.w3.org/ns/prov#atLocation> — _comment:_ The Location of any resource.
...
- **qualifiedDelegation** (*ObjectProperty*) — `qualifiedDelegation` — <http://www.w3.org/ns/prov#qualifiedDelegation> — _comment:_ If this Agent prov:actedOnBehalfOf Agent :ag, then it can qualify how with prov:qualifiedResponsibility [ a prov:Responsibility;  prov:agent :ag; :foo :bar ].
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#qualified Delegation http://www.w3.org/ns/prov#qualified delegation http://www.w3.org/ns/prov#qualifiedDelegation http://www.w3.org/ns/prov#qualifieddelegation qualified Delegation qualified delegation qualifiedDelegation qualifieddelegation</span>
...
- **Account** (*Class*) — `Account` — <http://openprovenance.org/model/opmo#Account>
  <span class='search-tokens' style='display:none'>Account account http://openprovenance.org/model/opmo# Account http://openprovenance.org/model/opmo# account http://openprovenance.org/model/opmo#Account http://openprovenance.org/model/opmo#account</span>
- **Usage** (*Class*) — `Usage` — <http://www.w3.org/ns/prov#Usage> — _comment:_ An instance of prov:Usage provides additional descriptions about the binary prov:used relation from some prov:Activity to an prov:Entity that it used. For example, :keynote prov:used :podium; prov:qualifiedUsage [ a prov:Usage; prov:entity :podium; :foo :bar ].
  <span class='search-tokens' style='display:none'>Usage http://www.w3.org/ns/prov# Usage http://www.w3.org/ns/prov# usage http://www.w3.org/ns/prov#Usage http://www.w3.org/ns/prov#usage usage</span>
...
- **has Executable Component** (*ObjectProperty*) — `hasExecutableComponent` — <http://www.opmw.org/ontology/hasExecutableComponent> — _comment:_ "Property that binds a workflow execution process to the specific component (code, scripts, etc.) used in the execution.
  <span class='search-tokens' style='display:none'>has  Executable  Component has  executable  component has Executable Component has executable component hasExecutableComponent hasexecutablecomponent http://www.opmw.org/ontology/has Executable Component http://www.opmw.org/ontology/has executable component http://www.opmw.org/ontology/hasExecutableComponent http://www.opmw.org/ontology/hasexecutablecomponent</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **Example:** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>Example: example:</span>
...
- **     a opmv:Process, opmw:WorkflowExecutionProcess;** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>     a opmv: Process, opmw: Workflow Execution Process;      a opmv: process, opmw: workflow execution process;      a opmv:Process, opmw:WorkflowExecutionProcess;      a opmv:process, opmw:workflowexecutionprocess;</span>
- **     opmw:hasExecutableComponent <http://www.opmw.org/export/resource/ReaerationEDM/COMPONENTREAERATIONEDM>."** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>     opmw:has Executable Component <http://www.opmw.org/export/resource/ ReaerationEDM/COMPONENTREAERATIONEDM>."      opmw:has executable component <http://www.opmw.org/export/resource/ reaerationedm/componentreaerationedm>."      opmw:hasExecutableComponent <http://www.opmw.org/export/resource/ReaerationEDM/COMPONENTREAERATIONEDM>."      opmw:hasexecutablecomponent <http://www.opmw.org/export/resource/reaerationedm/componentreaerationedm>."</span>
...
- **entity** (*ObjectProperty*) — `entity` — <http://www.w3.org/ns/prov#entity>
  <span class='search-tokens' style='display:none'>entity http://www.w3.org/ns/prov#entity</span>
- **hadPrimarySource** (*ObjectProperty*) — `hadPrimarySource` — <http://www.w3.org/ns/prov#hadPrimarySource>
  <span class='search-tokens' style='display:none'>had Primary Source had primary source hadPrimarySource hadprimarysource http://www.w3.org/ns/prov#had Primary Source http://www.w3.org/ns/prov#had primary source http://www.w3.org/ns/prov#hadPrimarySource http://www.w3.org/ns/prov#hadprimarysource</span>
- **executed in Workflow System** (*ObjectProperty*) — `executedInWorkflowSystem` — <http://www.opmw.org/ontology/executedInWorkflowSystem> — _comment:_ "Property to bind an execution account to the system where it was executed (which could be different from the one used for designing its workflow template).
  <span class='search-tokens' style='display:none'>executed In Workflow System executed in  Workflow  System executed in  workflow  system executed in Workflow System executed in workflow system executedInWorkflowSystem executedinworkflowsystem http://www.opmw.org/ontology/executed In Workflow System http://www.opmw.org/ontology/executed in workflow system http://www.opmw.org/ontology/executedInWorkflowSystem http://www.opmw.org/ontology/executedinworkflowsystem</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **Example:** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>Example: example:</span>
...
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **<http://www.opmw.org/export/resource/WorkflowExecutionAccount/acc1>** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'><http://www.opmw.org/export/resource/ Workflow Execution Account/acc1> <http://www.opmw.org/export/resource/ workflow execution account/acc1> <http://www.opmw.org/export/resource/WorkflowExecutionAccount/acc1> <http://www.opmw.org/export/resource/workflowexecutionaccount/acc1></span>
- **      a opmo:Account, opmw:executionAccount;** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>      a opmo: Account, opmw:execution Account;       a opmo: account, opmw:execution account;       a opmo:Account, opmw:executionAccount;       a opmo:account, opmw:executionaccount;</span>
- **      opmw:executedInWorkflowSystem <http://www.opmw.org/export/resource/Agent/SHELL>.** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>      opmw:executed In Workflow System <http://www.opmw.org/export/resource/ Agent/SHELL>.       opmw:executed in workflow system <http://www.opmw.org/export/resource/ agent/shell>.       opmw:executedInWorkflowSystem <http://www.opmw.org/export/resource/Agent/SHELL>.       opmw:executedinworkflowsystem <http://www.opmw.org/export/resource/agent/shell>.</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **<http://www.opmw.org/export/resource/Agent/SHELL> ** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'><http://www.opmw.org/export/resource/ Agent/SHELL>  <http://www.opmw.org/export/resource/ agent/shell>  <http://www.opmw.org/export/resource/Agent/SHELL>  <http://www.opmw.org/export/resource/agent/shell> </span>
- **     a opmw:Agent."** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>     a opmw: Agent."      a opmw: agent."      a opmw:Agent."      a opmw:agent."</span>
- **Influence** (*Class*) — `Influence` — <http://www.w3.org/ns/prov#Influence> — _comment:_ An instance of prov:Influence provides additional descriptions about the binary prov:wasInfluencedBy relation from some influenced Activity, Entity, or Agent to the influencing Activity, Entity, or Agent. For example, :stomach_ache prov:wasInfluencedBy :spoon; prov:qualifiedInfluence [ a prov:Influence; prov:entity :spoon; :foo :bar ] . Because prov:Influence is a broad relation, the more specific relations (Communication, Delegation, End, etc.) should be used when applicable.
  <span class='search-tokens' style='display:none'>Influence http://www.w3.org/ns/prov# Influence http://www.w3.org/ns/prov# influence http://www.w3.org/ns/prov#Influence http://www.w3.org/ns/prov#influence influence</span>
- **wasGeneratedBy** (*ObjectProperty*) — `wasGeneratedBy` — <http://www.w3.org/ns/prov#wasGeneratedBy>
...
- **Artifact** (*Class*) — `Artifact` — <http://purl.org/net/opmv/ns#Artifact>
  <span class='search-tokens' style='display:none'>Artifact artifact http://purl.org/net/opmv/ns# Artifact http://purl.org/net/opmv/ns# artifact http://purl.org/net/opmv/ns#Artifact http://purl.org/net/opmv/ns#artifact</span>
- **Invalidation** (*Class*) — `Invalidation` — <http://www.w3.org/ns/prov#Invalidation> — _comment:_ An instance of prov:Invalidation provides additional descriptions about the binary prov:wasInvalidatedBy relation from an invalidated prov:Entity to the prov:Activity that invalidated it. For example, :uncracked_egg prov:wasInvalidatedBy :baking; prov:qualifiedInvalidation [ a prov:Invalidation; prov:activity :baking; :foo :bar ].
  <span class='search-tokens' style='display:none'>Invalidation http://www.w3.org/ns/prov# Invalidation http://www.w3.org/ns/prov# invalidation http://www.w3.org/ns/prov#Invalidation http://www.w3.org/ns/prov#invalidation invalidation</span>
- **unqualifiedForm** (*AnnotationProperty*) — `unqualifiedForm` — <http://www.w3.org/ns/prov#unqualifiedForm> — _comment:_ Classes and properties used to qualify relationships are annotated with prov:unqualifiedForm to indicate the property used to assert an unqualified provenance relation.
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#unqualified Form http://www.w3.org/ns/prov#unqualified form http://www.w3.org/ns/prov#unqualifiedForm http://www.w3.org/ns/prov#unqualifiedform unqualified Form unqualified form unqualifiedForm unqualifiedform</span>
...
- **Communication** (*Class*) — `Communication` — <http://www.w3.org/ns/prov#Communication> — _comment:_ An instance of prov:Communication provides additional descriptions about the binary prov:wasInformedBy relation from an informed prov:Activity to the prov:Activity that informed it. For example, :you_jumping_off_bridge prov:wasInformedBy :everyone_else_jumping_off_bridge; prov:qualifiedCommunication [ a prov:Communication; prov:activity :everyone_else_jumping_off_bridge; :foo :bar ].
  <span class='search-tokens' style='display:none'>Communication communication http://www.w3.org/ns/prov# Communication http://www.w3.org/ns/prov# communication http://www.w3.org/ns/prov#Communication http://www.w3.org/ns/prov#communication</span>
- **prov-o** (*Individual*) — `prov-o` — <http://www.w3.org/ns/prov-o>
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov o http://www.w3.org/ns/prov-o prov o prov-o</span>
- **editorsDefinition** (*AnnotationProperty*) — `editorsDefinition` — <http://www.w3.org/ns/prov#editorsDefinition> — _comment:_ When the prov-o term does not have a definition drawn from prov-dm, and the prov-o editor provides one.
  <span class='search-tokens' style='display:none'>editors Definition editors definition editorsDefinition editorsdefinition http://www.w3.org/ns/prov#editors Definition http://www.w3.org/ns/prov#editors definition http://www.w3.org/ns/prov#editorsDefinition http://www.w3.org/ns/prov#editorsdefinition</span>
- **wasInfluencedBy** (*ObjectProperty*) — `wasInfluencedBy` — <http://www.w3.org/ns/prov#wasInfluencedBy> — _comment:_ Because prov:wasInfluencedBy is a broad relation, its more specific subproperties (e.g. prov:wasInformedBy, prov:actedOnBehalfOf, prov:wasEndedBy, etc.) should be used when applicable.
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#was Influenced By http://www.w3.org/ns/prov#was influenced by http://www.w3.org/ns/prov#wasInfluencedBy http://www.w3.org/ns/prov#wasinfluencedby was Influenced By was influenced by wasInfluencedBy wasinfluencedby</span>
- **has Value** (*DatatypeProperty*) — `hasValue` — <http://www.opmw.org/ontology/hasValue> — _comment:_ "Property used to state the value of the artifact (in case of being a parameter).
  <span class='search-tokens' style='display:none'>has  Value has  value has Value has value hasValue hasvalue http://www.opmw.org/ontology/has Value http://www.opmw.org/ontology/has value http://www.opmw.org/ontology/hasValue http://www.opmw.org/ontology/hasvalue</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **Example:** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>Example: example:</span>
...
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **<http://www.opmw.org/export/resource/WorkflowExecutionArtifact/DEPTH0.61959237>** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'><http://www.opmw.org/export/resource/ Workflow Execution Artifact/DEPTH0.61959237> <http://www.opmw.org/export/resource/ workflow execution artifact/depth0.61959237> <http://www.opmw.org/export/resource/WorkflowExecutionArtifact/DEPTH0.61959237> <http://www.opmw.org/export/resource/workflowexecutionartifact/depth0.61959237></span>
- **     a opmv:Artifact, opmw:WorkflowExecutionArtifact;** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>     a opmv: Artifact, opmw: Workflow Execution Artifact;      a opmv: artifact, opmw: workflow execution artifact;      a opmv:Artifact, opmw:WorkflowExecutionArtifact;      a opmv:artifact, opmw:workflowexecutionartifact;</span>
- **     opmw:hasValue ""0.61959237""^^xsd:string."** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>     opmw:has Value ""0.61959237""^^xsd:string."      opmw:has value ""0.61959237""^^xsd:string."      opmw:hasValue ""0.61959237""^^xsd:string."      opmw:hasvalue ""0.61959237""^^xsd:string."</span>
- **qualifiedGeneration** (*ObjectProperty*) — `qualifiedGeneration` — <http://www.w3.org/ns/prov#qualifiedGeneration> — _comment:_ If this Activity prov:generated Entity :e, then it can qualify how it performed the Generation using prov:qualifiedGeneration [ a prov:Generation;  prov:entity :e; :foo :bar ].
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#qualified Generation http://www.w3.org/ns/prov#qualified generation http://www.w3.org/ns/prov#qualifiedGeneration http://www.w3.org/ns/prov#qualifiedgeneration qualified Generation qualified generation qualifiedGeneration qualifiedgeneration</span>
- **qualifiedRevision** (*ObjectProperty*) — `qualifiedRevision` — <http://www.w3.org/ns/prov#qualifiedRevision> — _comment:_ If this Entity prov:wasRevisionOf Entity :e, then it can qualify how it was revised using prov:qualifiedRevision [ a prov:Revision;  prov:entity :e; :foo :bar ].
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#qualified Revision http://www.w3.org/ns/prov#qualified revision http://www.w3.org/ns/prov#qualifiedRevision http://www.w3.org/ns/prov#qualifiedrevision qualified Revision qualified revision qualifiedRevision qualifiedrevision</span>
- **MultiStep** (*Class*) — `MultiStep` — <http://purl.org/net/p-plan#MultiStep>
  <span class='search-tokens' style='display:none'>Multi Step MultiStep http://purl.org/net/p plan# Multi Step http://purl.org/net/p plan# multi step http://purl.org/net/p plan#MultiStep http://purl.org/net/p-plan#MultiStep http://purl.org/net/p-plan#multistep multi step multistep</span>
- **todo** (*AnnotationProperty*) — `todo` — <http://www.w3.org/ns/prov#todo>
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#todo todo</span>
...
- **Start** (*Class*) — `Start` — <http://www.w3.org/ns/prov#Start> — _comment:_ An instance of prov:Start provides additional descriptions about the binary prov:wasStartedBy relation from some started prov:Activity to an prov:Entity that started it. For example, :foot_race prov:wasStartedBy :bang; prov:qualifiedStart [ a prov:Start; prov:entity :bang; :foo :bar; prov:atTime '2012-03-09T08:05:08-05:00'^^xsd:dateTime ] .
  <span class='search-tokens' style='display:none'>Start http://www.w3.org/ns/prov# Start http://www.w3.org/ns/prov# start http://www.w3.org/ns/prov#Start http://www.w3.org/ns/prov#start start</span>
...
- **Location** (*Class*) — `Location` — <http://www.w3.org/ns/prov#Location>
  <span class='search-tokens' style='display:none'>Location http://www.w3.org/ns/prov# Location http://www.w3.org/ns/prov# location http://www.w3.org/ns/prov#Location http://www.w3.org/ns/prov#location location</span>
- **qualifiedPrimarySource** (*ObjectProperty*) — `qualifiedPrimarySource` — <http://www.w3.org/ns/prov#qualifiedPrimarySource> — _comment:_ If this Entity prov:hadPrimarySource Entity :e, then it can qualify how using prov:qualifiedPrimarySource [ a prov:PrimarySource; prov:entity :e; :foo :bar ].
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#qualified Primary Source http://www.w3.org/ns/prov#qualified primary source http://www.w3.org/ns/prov#qualifiedPrimarySource http://www.w3.org/ns/prov#qualifiedprimarysource qualified Primary Source qualified primary source qualifiedPrimarySource qualifiedprimarysource</span>
...
- **wasAssociatedWith** (*ObjectProperty*) — `wasAssociatedWith` — <http://www.w3.org/ns/prov#wasAssociatedWith> — _comment:_ An prov:Agent that had some (unspecified) responsibility for the occurrence of this prov:Activity.
...
- **qualifiedCommunication** (*ObjectProperty*) — `qualifiedCommunication` — <http://www.w3.org/ns/prov#qualifiedCommunication> — _comment:_ If this Activity prov:wasInformedBy Activity :a, then it can qualify how it was influenced using prov:qualifiedCommunication [ a prov:Communication;  prov:activity :a; :foo :bar ].
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#qualified Communication http://www.w3.org/ns/prov#qualified communication http://www.w3.org/ns/prov#qualifiedCommunication http://www.w3.org/ns/prov#qualifiedcommunication qualified Communication qualified communication qualifiedCommunication qualifiedcommunication</span>
- **wasStartedBy** (*ObjectProperty*) — `wasStartedBy` — <http://www.w3.org/ns/prov#wasStartedBy> — _comment:_ Start is when an activity is deemed to have started. A start may refer to an entity, known as trigger, that initiated the activity.
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#was Started By http://www.w3.org/ns/prov#was started by http://www.w3.org/ns/prov#wasStartedBy http://www.w3.org/ns/prov#wasstartedby was Started By was started by wasStartedBy wasstartedby</span>
- **value** (*DatatypeProperty*) — `value` — <http://www.w3.org/ns/prov#value>
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#value value</span>
- **http://www.w3.org/ns/prov-o#** (*Individual*) — `` — <http://www.w3.org/ns/prov-o#>
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov o# http://www.w3.org/ns/prov-o#</span>
- **has Size** (*DatatypeProperty*) — `hasSize` — <http://www.opmw.org/ontology/hasSize> — _comment:_ "Property used to annotate a workflow execution artifact with the size in bytes of its file.
  <span class='search-tokens' style='display:none'>has  Size has  size has Size has size hasSize hassize http://www.opmw.org/ontology/has Size http://www.opmw.org/ontology/has size http://www.opmw.org/ontology/hasSize http://www.opmw.org/ontology/hassize</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **Example** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>Example example</span>
...
- **      a opmv:Artifact, opmw:WorkflowExecutionArtifact.** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>      a opmv: Artifact, opmw: Workflow Execution Artifact.       a opmv: artifact, opmw: workflow execution artifact.       a opmv:Artifact, opmw:WorkflowExecutionArtifact.       a opmv:artifact, opmw:workflowexecutionartifact.</span>
- **      opmw:hasLocation ""68""^^xsd:int."** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>      opmw:has Location ""68""^^xsd:int."       opmw:has location ""68""^^xsd:int."       opmw:hasLocation ""68""^^xsd:int."       opmw:haslocation ""68""^^xsd:int."</span>
...
- **ActivityInfluence** (*Class*) — `ActivityInfluence` — <http://www.w3.org/ns/prov#ActivityInfluence> — _comment:_ ActivityInfluence provides additional descriptions of an Activity's binary influence upon any other kind of resource. Instances of ActivityInfluence use the prov:activity property to cite the influencing Activity.
  <span class='search-tokens' style='display:none'>Activity Influence ActivityInfluence activity influence activityinfluence http://www.w3.org/ns/prov# Activity Influence http://www.w3.org/ns/prov# activity influence http://www.w3.org/ns/prov#ActivityInfluence http://www.w3.org/ns/prov#activityinfluence</span>
- **Generation** (*Class*) — `Generation` — <http://www.w3.org/ns/prov#Generation> — _comment:_ An instance of prov:Generation provides additional descriptions about the binary prov:wasGeneratedBy relation from a generated prov:Entity to the prov:Activity that generated it. For example, :cake prov:wasGeneratedBy :baking; prov:qualifiedGeneration [ a prov:Generation; prov:activity :baking; :foo :bar ].
  <span class='search-tokens' style='display:none'>Generation generation http://www.w3.org/ns/prov# Generation http://www.w3.org/ns/prov# generation http://www.w3.org/ns/prov#Generation http://www.w3.org/ns/prov#generation</span>
...
- **EntityInfluence** (*Class*) — `EntityInfluence` — <http://www.w3.org/ns/prov#EntityInfluence> — _comment:_ EntityInfluence provides additional descriptions of an Entity's binary influence upon any other kind of resource. Instances of EntityInfluence use the prov:entity property to cite the influencing Entity.
  <span class='search-tokens' style='display:none'>Entity Influence EntityInfluence entity influence entityinfluence http://www.w3.org/ns/prov# Entity Influence http://www.w3.org/ns/prov# entity influence http://www.w3.org/ns/prov#EntityInfluence http://www.w3.org/ns/prov#entityinfluence</span>
...
- **Bundle** (*Class*) — `Bundle` — <http://www.w3.org/ns/prov#Bundle> — _comment:_ Note that there are kinds of bundles (e.g. handwritten letters, audio recordings, etc.) that are not expressed in PROV-O, but can be still be described by PROV-O.
...
- **isSubPlanOfPlan** (*ObjectProperty*) — `isSubPlanOfPlan` — <http://purl.org/net/p-plan#isSubPlanOfPlan>
  <span class='search-tokens' style='display:none'>http://purl.org/net/p plan#is Sub Plan Of Plan http://purl.org/net/p plan#is sub plan of plan http://purl.org/net/p plan#isSubPlanOfPlan http://purl.org/net/p-plan#isSubPlanOfPlan http://purl.org/net/p-plan#issubplanofplan is Sub Plan Of Plan is sub plan of plan isSubPlanOfPlan issubplanofplan</span>
- **http://www.w3.org/ns/prov#** (*Individual*) — `` — <http://www.w3.org/ns/prov#>
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#</span>
- **component** (*AnnotationProperty*) — `component` — <http://www.w3.org/ns/prov#component> — _comment:_ Classify prov-o terms into six components according to prov-dm, including 'agents-responsibility', 'alternate', 'annotations', 'collections', 'derivations', and 'entities-activities'. This classification is used so that readers of prov-o specification can find its correspondence with the prov-dm specification.
  <span class='search-tokens' style='display:none'>component http://www.w3.org/ns/prov#component</span>
...
- **      opmw:template              <http://www.opmw.org/export/resource/WorkflowTemplate/AQUAFLOW_NTM> ."** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>      opmw:template              <http://www.opmw.org/export/resource/ Workflow Template/AQUAFLOW NTM> ."       opmw:template              <http://www.opmw.org/export/resource/ workflow template/aquaflow ntm> ."       opmw:template              <http://www.opmw.org/export/resource/WorkflowTemplate/AQUAFLOW NTM> ."       opmw:template              <http://www.opmw.org/export/resource/WorkflowTemplate/AQUAFLOW_NTM> ."       opmw:template              <http://www.opmw.org/export/resource/workflowtemplate/aquaflow_ntm> ."</span>
- **wasDerivedFrom** (*ObjectProperty*) — `wasDerivedFrom` — <http://www.w3.org/ns/prov#wasDerivedFrom> — _comment:_ The more specific subproperties of prov:wasDerivedFrom (i.e., prov:wasQuotedFrom, prov:wasRevisionOf, prov:hadPrimarySource) should be used when applicable.
...
- **has Status** (*DatatypeProperty*) — `hasStatus` — <http://www.opmw.org/ontology/hasStatus> — _comment:_ "Property used to state whether an ececution account was successful or not.
  <span class='search-tokens' style='display:none'>has  Status has  status has Status has status hasStatus hasstatus http://www.opmw.org/ontology/has Status http://www.opmw.org/ontology/has status http://www.opmw.org/ontology/hasStatus http://www.opmw.org/ontology/hasstatus</span>
- **** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'></span>
- **Example:** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>Example: example:</span>
...
- **      a opmo:Account, opmw:ExecutionAccount;** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>      a opmo: Account, opmw: Execution Account;       a opmo: account, opmw: execution account;       a opmo:Account, opmw:ExecutionAccount;       a opmo:account, opmw:executionaccount;</span>
- **      opmw:hasStatus ""SUCCESS""^^xsd.string."** (*Entity*) — `` — <>
  <span class='search-tokens' style='display:none'>      opmw:has Status ""SUCCESS""^^xsd.string."       opmw:has status ""success""^^xsd.string."       opmw:hasStatus ""SUCCESS""^^xsd.string."       opmw:hasstatus ""success""^^xsd.string."</span>
- **End** (*Class*) — `End` — <http://www.w3.org/ns/prov#End> — _comment:_ An instance of prov:End provides additional descriptions about the binary prov:wasEndedBy relation from some ended prov:Activity to an prov:Entity that ended it. For example, :ball_game prov:wasEndedBy :buzzer; prov:qualifiedEnd [ a prov:End; prov:entity :buzzer; :foo :bar; prov:atTime '2012-03-09T08:05:08-05:00'^^xsd:dateTime ].
  <span class='search-tokens' style='display:none'>End end http://www.w3.org/ns/prov# End http://www.w3.org/ns/prov# end http://www.w3.org/ns/prov#End http://www.w3.org/ns/prov#end</span>
...
- **qualifiedUsage** (*ObjectProperty*) — `qualifiedUsage` — <http://www.w3.org/ns/prov#qualifiedUsage> — _comment:_ If this Activity prov:used Entity :e, then it can qualify how it used it using prov:qualifiedUsage [ a prov:Usage; prov:entity :e; :foo :bar ].
  <span class='search-tokens' style='display:none'>http://www.w3.org/ns/prov#qualified Usage http://www.w3.org/ns/prov#qualified usage http://www.w3.org/ns/prov#qualifiedUsage http://www.w3.org/ns/prov#qualifiedusage qualified Usage qualified usage qualifiedUsage qualifiedusage</span>
- **AgentInfluence** (*Class*) — `AgentInfluence` — <http://www.w3.org/ns/prov#AgentInfluence> — _comment:_ AgentInfluence provides additional descriptions of an Agent's binary influence upon any other kind of resource. Instances of AgentInfluence use the prov:agent property to cite the influencing Agent.
  <span class='search-tokens' style='display:none'>Agent Influence AgentInfluence agent influence agentinfluence http://www.w3.org/ns/prov# Agent Influence http://www.w3.org/ns/prov# agent influence http://www.w3.org/ns/prov#AgentInfluence http://www.w3.org/ns/prov#agentinfluence</span>
- **Derivation** (*Class*) — `Derivation` — <http://www.w3.org/ns/prov#Derivation> — _comment:_ An instance of prov:Derivation provides additional descriptions about the binary prov:wasDerivedFrom relation from some derived prov:Entity to another prov:Entity from which it was derived. For example, :chewed_bubble_gum prov:wasDerivedFrom :unwrapped_bubble_gum; prov:qualifiedDerivation [ a prov:Derivation; prov:entity :unwrapped_bubble_gum; :foo :bar ].
  <span class='search-tokens' style='display:none'>Derivation derivation http://www.w3.org/ns/prov# Derivation http://www.w3.org/ns/prov# derivation http://www.w3.org/ns/prov#Derivation http://www.w3.org/ns/prov#derivation</span>